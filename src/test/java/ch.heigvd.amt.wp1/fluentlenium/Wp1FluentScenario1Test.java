...
public class Wp1FluentScenario1Test extends FluentTest {
  ...
  public void devAppShouldRegisterCreateAppsBrowseAndLogOut() {
    ...
    appsFluentPage.containsNElements("Showing 1 to 10"); // amount of apps/page OK
    appsFluentPage.clickNext();
    await().untilPage(appsFluentPage).isLoaded();
    appsFluentPage.containsNElements("Showing 11 to 20"); // amount of apps/page OK
    appsFluentPage.clickNext();
    await().untilPage(appsFluentPage).isLoaded();
    appsFluentPage.containsNElements("Showing 21 to 25"); // amount of apps/page OK
